...
module.exports = {
    ...
    name: ['çeviri'], //arraya istediğiniz kadar kullanım yazabilirsiniz alieses gibi saçma bir şeyle uğraşmak yerine direk arraya ekleyebilirsiniz.
    description: "Google'dan çeviri yapmanızı sağlar.",
    kategori: "Genel",
...
Örnek: \`+çeviri en storm\``)
		...
		const embed = new Discord.MessageEmbed()
			.setAuthor(`SwankyBot - Google Çeviri`,'https://images.techhive.com/images/article/2017/05/pcw-translate-primary-100723319-orig.jpg', 'https://translate.google.com/')
