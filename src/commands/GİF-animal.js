...
module.exports = {
    ...
    name: ['animal'], //arraya istediğiniz kadar kullanım yazabilirsiniz alieses gibi saçma bir şeyle uğraşmak yerine direk arraya ekleyebilirsiniz.
    description: "Rastgele bir animal gif atar.",
    kategori: "Gif",
